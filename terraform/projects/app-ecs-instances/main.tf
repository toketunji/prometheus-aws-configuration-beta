...
#Create ECS cluster within ECS with no container instances
...
#Creates auto scaling group based on modules provided by aws. 
#This resource should be tainted in order to create a freash instance
module "ecs_instance" {
